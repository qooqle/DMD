 ...
 */
package org.opendaylight.dmd.cli.commands;
...
public class DmdCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(DmdCliTestCommand.class);
    protected final DmdCliCommands service;

    public DmdCliTestCommand(final DmdCliCommands service) {
